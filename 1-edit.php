...
// ログインページへリダイレクト
header("Location: ./1-admin.php");exit;}
...
if( empty($message_data) ) {header("Location: ./1-admin.php");exit;}
...
// 更新に成功したら一覧に戻る
if( $res ) {header("Location: ./1-admin.php");exit;}}}

$stmt = null;$pdo = null;?>
<!DOCTYPE html><html lang="ja"><head><meta charset="utf-8"><title>EDIT / 編集</title>
<style>


</head><body><h1>EDIT / 編集</h1><?php if( !empty($error_message) ): ?><ul class="error_message"><?php foreach( $error_message as $value ): ?>
...
<a class="btn_cancel" href="1-admin.php">キャンセル</a>
